            ...
            {portfolioProjects.map((project, index) => (
              ...
              >
                <div className="relative aspect-[4/3] overflow-hidden rounded-xl">
                  <div className="absolute inset-0 flex items-center justify-center bg-red-950/30 text-white p-6 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="text-center">
                      <h3 className="text-xl font-bold mb-2">{project.title}</h3>
                      <p className="text-red-200/70 mb-4">{project.category}</p>
                      <Button 
                        variant="outline" 
                        size="sm" 
                        className="border-red-400/30 text-red-200 hover:bg-red-900/30"
                      >
                        View Project
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-red-950/40 to-red-900/10 rounded-lg group-hover:opacity-0 transition-opacity"></div>
                  <div className="w-full h-full flex items-center justify-center bg-black/60 border border-red-950/30">
                    <p className="text-red-200/70">Project Image Placeholder</p>
                  </div>
                </div>
                <div className="mt-4">
                  <Badge className="bg-red-900/20 text-red-400 border-transparent">{project.category}</Badge>
        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-12">
          <div className="max-w-4xl mx-auto">
            <motion.div 
              ...
              variants={fadeIn}
            >
              <Badge className="bg-red-900/30 text-red-400 border-transparent mb-4 px-3 py-1">CONTACT US</Badge>
              <h2 className="text-3xl md:text-4xl font-bold text-white mt-2 mb-4">
                Ready to Start Your Project?
              </h2>
              <p className="text-red-200/70 max-w-2xl mx-auto">
                Tell us about your project and we'll get back to you within 24 hours with a free consultation.
              </p>
            </motion.div>
            
            <motion.div 
              className="bg-black/60 border border-red-950/30 rounded-xl p-6 md:p-8"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
              variants={fadeIn}
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    <label htmlFor="name" className="block text-red-200 mb-2">Name</label>
                    <Input 
                      id="name"
                      className="bg-black/40 border-red-950/30 text-red-200 focus:border-red-700"
                      placeholder="Your name"
                    />
                  </div>
                  <div>
                    <label htmlFor="email" className="block text-red-200 mb-2">Email</label>
                    <Input 
                      id="email"
                      type="email"
                      className="bg-black/40 border-red-950/30 text-red-200 focus:border-red-700"
                  ...
                  <div>
                    <label htmlFor="service" className="block text-red-200 mb-2">Service</label>
                    <select 
                      id="service"
                      className="w-full bg-black/40 border-red-950/30 text-red-200 focus:border-red-700 rounded-md p-2"
                    >
                ...
                <div className="space-y-4">
                  <div className="h-full">
                    <label htmlFor="message" className="block text-red-200 mb-2">Project Details</label>
                    <Textarea 
                      id="message"
                      className="bg-black/40 border-red-950/30 text-red-200 focus:border-red-700 h-32"
